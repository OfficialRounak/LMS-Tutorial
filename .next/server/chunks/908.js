...
__webpack_require__.d(__webpack_exports__, {
  ...
  qu: () => (/* reexport */ SignInWithMetamaskButton),
...
// UNUSED EXPORTS: __internal__setErrorThrowerOptions
...
;// CONCATENATED MODULE: ./node_modules/@clerk/shared/dist/chunk-KJVJ4CFF.mjs
...
var chunk_KJVJ4CFF_deprecated = (fnName, warning, key) => {
...
var deprecatedProperty = (cls, propName, warning, isStatic = false) => {
  ...
  Object.defineProperty(target, propName, {
    get() {
      chunk_KJVJ4CFF_deprecated(propName, warning, `${cls.name}:${propName}`);
      return value;
    },
    set(v) {
      value = v;
...
var deprecatedObjectProperty = (obj, propName, warning, key) => {
  ...
  Object.defineProperty(obj, propName, {
    get() {
      chunk_KJVJ4CFF_deprecated(propName, warning, key);
      return value;
    },
    set(v) {
      value = v;
...
var ClerkAPIResponseError = class _ClerkAPIResponseError extends (/* unused pure expression or super */ null && (Error)) {
...
var MagicLinkError = class _MagicLinkError extends Error {
  constructor(code) {
    ...
    chunk_KJVJ4CFF_deprecated("MagicLinkError", "Use `EmailLinkError` instead.");
  }
};
...
function isMagicLinkError(err) {
  chunk_KJVJ4CFF_deprecated("isMagicLinkError", "Use `isEmailLinkError` instead.");
...
var MagicLinkErrorCode = new Proxy(_MagicLinkErrorCode, {
  get(target, prop, receiver) {
    chunk_KJVJ4CFF_deprecated("MagicLinkErrorCode", "Use `EmailLinkErrorCode` instead.");
...
;// CONCATENATED MODULE: ./node_modules/@clerk/shared/dist/chunk-M7N63FRO.mjs
...
var getScriptUrl = (frontendApi, { pkgVersion = "4.70.1", clerkJSVersion }) => {
...
//# sourceMappingURL=chunk-M7N63FRO.mjs.map
...
const versionSelector = (clerkJSVersion) => {
  ...
  const prereleaseTag = getPrereleaseTag("4.30.6");
  if (prereleaseTag) {
...
const _IsomorphicClerk = class _IsomorphicClerk {
  constructor(options) {
    ...
    this.setSession = (session, beforeEmit) => {
      chunk_KJVJ4CFF_deprecated("setSession", "Use `Clerk.setActive` instead");
    ...
    this.handleMagicLinkVerification = async (params) => {
      chunk_KJVJ4CFF_deprecated("handleMagicLinkVerification", "Use `handleEmailLinkVerification` instead.");
  ...
  async loadClerkJS() {
    ...
    try {
      ...
      global.Clerk.sdkMetadata = this.options.sdkMetadata ?? { name: "@clerk/clerk-react", version: "4.30.6" };
...
var createContextAndHook = (displayName, options) => {
  ...
  const Ctx = react_.createContext(void 0);
  Ctx.displayName = displayName;
  const useCtx = () => {
    const ctx = react_.useContext(Ctx);
...
__reExport(clerk_swr_exports, core_dist_namespaceObject);
...
var OrganizationProvider = ({
  ...
  return /* @__PURE__ */ react_.createElement(dist_SWRConfig, { value: swrConfig }, /* @__PURE__ */ react_.createElement(
...
var useOrganization = (params) => {
  ...
  if (invitationListParams) {
    chunk_KJVJ4CFF_deprecated("invitationList in useOrganization", "Use the `invitations` property and return value instead.");
  }
  const {
    data: invitationList,
  ...
  if (membershipListParams) {
    chunk_KJVJ4CFF_deprecated("membershipList in useOrganization", "Use the `memberships` property and return value instead.");
  }
  const {
    data: membershipList,
...
var useOrganizations = () => {
  chunk_KJVJ4CFF_deprecated("useOrganizations", "Use useOrganizationList, useOrganization, or useClerk instead.");
  const clerk = useClerkInstanceContext();
  if (!clerk.loaded) {
    return {
      isLoaded: false,
...
function ClerkContextProvider(props) {
  ...
  if (isomorphicClerkOptions.frontendApi) {
    chunk_KJVJ4CFF_deprecated("frontendApi", "Use `publishableKey` instead.");
  }
...
;// CONCATENATED MODULE: ./node_modules/@clerk/shared/dist/chunk-5QXIOV6T.mjs
// src/underscore.ts
...
;// CONCATENATED MODULE: ./node_modules/@clerk/shared/dist/chunk-5JU2E5TY.mjs
// src/file.ts
...
;// CONCATENATED MODULE: ./node_modules/@clerk/shared/dist/index.mjs
...
;// CONCATENATED MODULE: ./node_modules/@clerk/clerk-react/dist/esm/utils/useCustomElementPortal.js



const useCustomElementPortal = (elements) => {
  const initialState = Array(elements.length).fill(null);
  const [nodes, setNodes] = (0,react_.useState)(initialState);
  return elements.map((el, index) => ({
    ...
    portal: () => /* @__PURE__ */ react_default().createElement((react_default()).Fragment, null, nodes[index] ? (0,server_rendering_stub_.createPortal)(el.component, nodes[index]) : null)
  }));
};

//# sourceMappingURL=useCustomElementPortal.js.map
;// CONCATENATED MODULE: ./node_modules/@clerk/clerk-react/dist/esm/utils/useCustomPages.js
...
const isThatComponent = (v, component) => {
  return !!v && react_default().isValidElement(v) && v?.type === component;
};
...
class Portal extends (react_default()).PureComponent {
  ...
  render() {
    return /* @__PURE__ */ react_default().createElement((react_default()).Fragment, null, /* @__PURE__ */ react_default().createElement("div", { ref: this.portalRef }), this.props?.customPagesPortals?.map((portal, index) => (0,react_.createElement)(portal, { key: index })));
  }
}
...
const useAuth = () => {
  ...
  const has = (0,react_.useCallback)(
    (params) => {
...
const Protect = ({ children, fallback, ...restAuthorizedParams }) => {
  ...
  const unauthorized = /* @__PURE__ */ react_default().createElement((react_default()).Fragment, null, fallback ?? null);
...
;// CONCATENATED MODULE: ./node_modules/@clerk/clerk-react/dist/esm/components/SignInWithMetamaskButton.js
...
function useMagicLink(resource) {
  chunk_KJVJ4CFF_deprecated("useMagicLink", "Use `useEmailLink` instead.");
...
;// CONCATENATED MODULE: ./node_modules/@clerk/clerk-react/dist/esm/hooks/useEmailLink.js
...
// EXTERNAL MODULE: ./node_modules/@clerk/clerk-react/dist/esm/index.js + 66 modules
var esm = __webpack_require__(90238);
...
const mergeNextClerkPropsWithEnv = (props) => {
  return {
    ...
    publishableKey: props.publishableKey || "pk_test_a25vd24tYnVmZmFsby00Ni5jbGVyay5hY2NvdW50cy5kZXYk" || 0,
...
const useAwaitableNavigate = () => {
  ...
  const clerkNavRef = (0,react_.useRef)();
  const clerkNavPromiseBuffer = (0,react_.useRef)([]);
...
/* harmony export */   Protect: () => (/* reexport safe */ _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__.Cv),
...
/* harmony export */ });
/* harmony import */ var _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(90238);
"use client";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   EmailLinkErrorCode: () => (/* reexport safe */ _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__._L),
...
/* harmony export */   isEmailLinkError: () => (/* reexport safe */ _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__.G1),
...
/* harmony export */   useEmailLink: () => (/* reexport safe */ _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__.E2),
...
/* harmony export */   OrganizationList: () => (/* reexport safe */ _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__.Bg),
...
/* harmony export */   SignInWithMetamaskButton: () => (/* reexport safe */ _clerk_clerk_react__WEBPACK_IMPORTED_MODULE_0__.qu),
...
module.exports = createProxy("/Users/roubhatt/Desktop/LMS Personal/LMS-Tutorial/node_modules/next/dist/client/components/app-router.js");
 //# sourceMappingURL=app-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(61363);
module.exports = createProxy("/Users/roubhatt/Desktop/LMS Personal/LMS-Tutorial/node_modules/next/dist/client/components/error-boundary.js");
 //# sourceMappingURL=error-boundary.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(61363);
module.exports = createProxy("/Users/roubhatt/Desktop/LMS Personal/LMS-Tutorial/node_modules/next/dist/client/components/layout-router.js");
 //# sourceMappingURL=layout-router.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(61363);
module.exports = createProxy("/Users/roubhatt/Desktop/LMS Personal/LMS-Tutorial/node_modules/next/dist/client/components/render-from-template-context.js");
 //# sourceMappingURL=render-from-template-context.js.map
...
/* __next_internal_client_entry_do_not_use__  cjs */ 
const { createProxy } = __webpack_require__(61363);
module.exports = createProxy("/Users/roubhatt/Desktop/LMS Personal/LMS-Tutorial/node_modules/next/dist/client/components/static-generation-searchparams-bailout-provider.js");
 //# sourceMappingURL=static-generation-searchparams-bailout-provider.js.map
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/roubhatt/Desktop/LMS Personal/LMS-Tutorial/node_modules/react-hot-toast/dist/index.mjs`)
