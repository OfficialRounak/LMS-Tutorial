...
var t=function(e,t,i){if(e&&"reportValidity"in e){var n=(0,index_esm/* get */.U2)(i,t);e.setCustomValidity(n&&n.message||""),e.reportValidity()}},resolvers_i=function(r,e){var i=function(i){var n=e.fields[i];n&&n.ref&&"reportValidity"in n.ref?t(n.ref,i,r):n.refs&&n.refs.forEach(function(e){return t(e,i,r)})};for(var n in e.fields)i(n)},n=function(t,n){n.shouldUseNativeValidation&&resolvers_i(t,n);var f={};for(var a in t){var s=(0,index_esm/* get */.U2)(n.fields,a),u=Object.assign(t[a]||{},{ref:s&&s.ref});if(o(n.names||Object.keys(t),a)){var c=Object.assign({},(0,index_esm/* get */.U2)(f,a));(0,index_esm/* set */.t8)(c,"root",u),(0,index_esm/* set */.t8)(f,a,c)}else (0,index_esm/* set */.t8)(f,a,u)}return f},o=function(r,e){return r.some(function(r){return r.startsWith(e+".")})};
